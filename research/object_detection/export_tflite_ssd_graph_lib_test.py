...
class ExportTfliteGraphTest(tf.test.TestCase):
    ...
    def _import_graph_and_run_inference(
            self, tflite_graph_file, num_channels=3):
        ...
        with graph.as_default():
            ...
            input_tensor = graph.get_tensor_by_name(
                'normalized_input_image_tensor:0')
            box_encodings = graph.get_tensor_by_name(
