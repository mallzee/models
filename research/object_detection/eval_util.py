        ...
        try:
            for batch in range(int(num_batches)):
                ...
                for evaluator in evaluators:
                    ...
                    # add_single_ground_truth_image_info expects a single
                    # image. Fix
...
def result_dict_for_single_example(image,
    ...
    if groundtruth:
        ...
        if class_agnostic:
            ...
            groundtruth_classes = tf.ones_like(
                groundtruth_classes, dtype=tf.int64)
...
def get_eval_metric_ops_for_evaluators(eval_config,
    ...
    evaluators_list = get_evaluators(
